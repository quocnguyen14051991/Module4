...
public class DigitalServiceImpl implements DigitalService {
    ...
    @Override
    public List<Digital> findByTitle(String author) {

        return digitalRepository.findAllByTitle(author);
    }

    @Override
    public List<Digital> findAllByLoadMore(int start, int limit) {
        return digitalRepository.findAllByLoad(start, limit);
    }
